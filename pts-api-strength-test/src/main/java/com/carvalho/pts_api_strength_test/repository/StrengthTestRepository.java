...
public interface StrengthTestRepository extends JpaRepository<StrengthTestEntity, Long> {
    ...
    List<StrengthTestEntity> findByAthleteIdOrderByCreatedAtDesc(String athleteId);

    Page<StrengthTestEntity> findByAthleteId(String athleteId, Pageable pageable);
