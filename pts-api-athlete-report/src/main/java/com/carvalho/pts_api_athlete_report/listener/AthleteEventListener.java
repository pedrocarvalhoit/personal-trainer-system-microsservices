...
public class AthleteEventListener {
    ...
    public AthleteEventListener(AthleteReportServiceImpl service) {
        this.service = service;
    }

    @Transactional
    @RabbitListener(queues = "user.athlete.report.queue", containerFactory = "rabbitListenerContainerFactory")
